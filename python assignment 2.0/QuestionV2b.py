...
# Read data generated from Question 1
portfolio_df = pd.read_csv("portfolio_analysis.csv")
...
# Add new column
portfolio_df["Performance Category"] = (
    portfolio_df["Return Percentage"]
    .apply(performance_category)
)

print("===== Portfolio with Categories =====")
print(portfolio_df)
...
print("\n===== Average Estimated Return by Category =====")
print(group_result)
